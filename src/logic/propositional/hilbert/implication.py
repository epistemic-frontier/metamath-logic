...
def prove_elimh(sys: System) -> Proof:
    ...
    Hypothesis builder for the weak deduction theorem.  Split on χ and
    reduce the conditional to φ or ψ in the respective branch.
...
def prove_justify_df(sys: System) -> Proof:
    ...
    Pass through the alpha-renaming justification hypothesis used by the
    definition scheme.
    """
    lb = ProofBuilder(sys, "justify-df")
    hyp = lb.hyp("justify-df.1", "φ")
    return lb.build(hyp)
...
def prove_pm11_07(sys: System) -> Proof:
    ...
    The formalized statement of *11.07 is exactly its hypothesis.
    """
    lb = ProofBuilder(sys, "pm11.07")
    hyp = lb.hyp("pm11.07.1", "φ")
    return lb.build(hyp)
...
def prove_retbwax1(sys: System) -> Proof:
    ...
    Re-derive tbw-ax1 from the merco1 axiom system.
    ...
    s60 = lb.ref(
        "s60",
        "( ( ( ψ → ( φ → χ ) ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) )",
        ref="merco1lem16",
        note="merco1lem16",
    )
    s61 = lb.mp("s61", s49, s60, "ax-mp")
    s315 = lb.ref(
        "s315",
        "( ( ( φ → ψ ) → ( φ → χ ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) )",
        ref="merco1lem15",
    ...
    s345 = lb.ref(
        "s345",
        "( ( ( ( φ → ψ ) → ( φ → χ ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) → ( ( ( φ → ψ ) → ( φ → χ ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) )",
        ref="merco1lem15",
        note="merco1lem15",
    )
    s346 = lb.mp("s346", s315, s345, "ax-mp")
    s376 = lb.ref(
        "s376",
        "( ( ( ( φ → ψ ) → ( φ → χ ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) )",
        ref="merco1lem18",
        note="merco1lem18",
    )
    s377 = lb.mp("s377", s346, s376, "ax-mp")
    s411 = lb.ref(
        "s411",
        "( ( ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) )",
        ref="merco1lem14",
        note="merco1lem14",
    )
    s412 = lb.mp("s412", s377, s411, "ax-mp")
    s808 = lb.ref(
        "s808",
        "( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( φ → χ ) ) → ( ( ψ → χ ) → ( φ → χ ) ) )",
        ref="merco1lem14",
        note="merco1lem14",
    )
    s1798 = lb.ref(
        "s1798",
        "( ( ( ( ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ⊥ ) → ⊥ ) → ( ( ( ( ψ → χ ) → ( φ → χ ) ) → φ ) → ⊥ ) ) → ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) ) → ( ( ( φ → χ ) → φ ) → ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) ) )",
        ref="merco1lem10",
        note="merco1lem10",
    )
    s1976 = lb.ref(
        "s1976",
        "( ( ( ( ( ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ⊥ ) → ⊥ ) → ( ( ( ( ψ → χ ) → ( φ → χ ) ) → φ ) → ⊥ ) ) → ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) ) → ( ( ( φ → χ ) → φ ) → ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) ) ) → ( ( ( ( ( φ → χ ) → φ ) → ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) ) → ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ⊥ ) ) → ( ( ( ( ψ → χ ) → ( φ → χ ) ) → φ ) → ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ⊥ ) ) ) )",
        ref="merco1",
        note="merco1",
    )
    s1977 = lb.mp("s1977", s1798, s1976, "ax-mp")
    s2153 = lb.ref(
        "s2153",
        "( ( ( ( ( ( φ → χ ) → φ ) → ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) ) → ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ⊥ ) ) → ( ( ( ( ψ → χ ) → ( φ → χ ) ) → φ ) → ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ⊥ ) ) ) → ( ( ( ( ( ( ψ → χ ) → ( φ → χ ) ) → φ ) → ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ⊥ ) ) → ( φ → χ ) ) → ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( φ → χ ) ) ) )",
        ref="merco1",
        note="merco1",
    )
    s2154 = lb.mp("s2154", s1977, s2153, "ax-mp")
    s2274 = lb.ref(
        "s2274",
        "( ( ( ( ( ( ( ψ → χ ) → ( φ → χ ) ) → φ ) → ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ⊥ ) ) → ( φ → χ ) ) → ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( φ → χ ) ) ) → ( ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( φ → χ ) ) → ( ( ψ → χ ) → ( φ → χ ) ) ) → ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) )",
        ref="merco1",
        note="merco1",
    )
    s2275 = lb.mp("s2275", s2154, s2274, "ax-mp")
    s2276 = lb.mp("s2276", s808, s2275, "ax-mp")
    s2340 = lb.ref(
        "s2340",
        "( ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) → ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) )",
        ref="merco1lem15",
        note="merco1lem15",
    )
    s2341 = lb.mp("s2341", s2276, s2340, "ax-mp")
    s3395 = lb.ref(
        "s3395",
        "( ( ( ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) ) → ( ( ( ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) ) )",
        ref="merco1lem10",
        note="merco1lem10",
    )
    s3588 = lb.ref(
    ...
    s3589 = lb.mp("s3589", s3395, s3588, "ax-mp")
    s3756 = lb.ref(
        "s3756",
        "( ( ( ( ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) ) → ( ( ( ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ⊥ ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) → ( ( ( ψ → χ ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) → ( ( ( ψ → χ ) → ( ( φ → ψ ) → ( φ → χ ) ) ) → ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) ) )",
        ref="merco1lem13",
        note="merco1lem13",
    )
    s3757 = lb.mp("s3757", s3589, s3756, "ax-mp")
    s3758 = lb.mp("s3758", s2341, s3757, "ax-mp")
    s3759 = lb.mp("s3759", s412, s3758, "ax-mp")
    s3760 = lb.mp("s3760", s61, s3759, "ax-mp")
    return lb.build(s3760)
...
def prove_sylancbr(sys: System) -> Proof:
    ...
    Inference joining two reversed biconditionals with a conjunction;
    sylanc with biconditional replacements for the hypotheses
    (reversed form of sylancb).
    (Contributed by NM, 1-May-1995.)
    set.mm proof: syl2anbr anidms.
    """
    ...
    s1 = lb.ref(
        ...
        h3,
        ref="syl2anbr",
        note="syl2anbr sylancbr.1, sylancbr.2, sylancbr.3",
    )
    res = lb.ref("res", "φ → θ", s1, ref="anidms", note="anidms s1")
    return lb.build(res)
...
def prove_ecase33d(sys: System) -> Proof:
    """ecase33d: φ → θ.

    Hyps: ecase33d.1: φ → ¬ ψ, ecase33d.2: φ → ¬ χ, ecase33d.3: φ → ( ψ ∨ χ ∨ θ ).

    Deduction for elimination by cases with three alternatives, where the
    first and second are eliminated by their negations.
    (Contributed by NM, 29-Dec-1992.)
    """
    lb = ProofBuilder(sys, "ecase33d")
    h1 = lb.hyp("ecase33d.1", "φ → ¬ ψ")
    h2 = lb.hyp("ecase33d.2", "φ → ¬ χ")
    h3 = lb.hyp("ecase33d.3", "φ → ( ψ ∨ χ ∨ θ )")
    s1 = lb.ref(
        "s1",
        "( ψ ∨ χ ∨ θ ) ↔ ( ( ψ ∨ χ ) ∨ θ )",
        ref="df-3or",
...
def prove_nic_luk1(sys: System) -> Proof:
    ...
    Derivation of the syllogism (hypothetical syllogism) from Nicod's
    axiom system using the Sheffer stroke (NAND) as the primitive
    connective and the NAND-based definition of implication.
    """
    lb = ProofBuilder(sys, "nic-luk1")

    # Step 1: nic-dfim — define φ → ψ in terms of ⊼
    s1 = lb.ref(
        "s1",
    ...
    # Step 2: nic-bi2(s1) — extract (φ → ψ) ⊼ ((φ ⊼ (ψ ⊼ ψ)) ⊼ (φ ⊼ (ψ ⊼ ψ)))
    s2 = lb.ref(
        "s2",
        "( φ → ψ ) ⊼ ( ( φ ⊼ ( ψ ⊼ ψ ) ) ⊼ ( φ ⊼ ( ψ ⊼ ψ ) ) )",
        s1,
    ...
    # Step 3: nic-ax with substitution φ→φ, χ→ψ, ψ→ψ, τ→τ, θ→(χ ⊼ χ)
    s3 = lb.ref(
        "s3",
        "( φ ⊼ ( ψ ⊼ ψ ) ) ⊼ ( ( τ ⊼ ( τ ⊼ τ ) ) ⊼ ( ( ( χ ⊼ χ ) ⊼ ψ ) ⊼ ( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ ⊼ ( χ ⊼ χ ) ) ) ) )",
        ref="nic-ax",
        note="nic-ax",
    )
    ...
    s5 = lb.ref(
        "s5",
        "( φ ⊼ ( ψ ⊼ ψ ) ) ⊼ ( ( ( ( χ ⊼ χ ) ⊼ ψ ) ⊼ ( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ ⊼ ( χ ⊼ χ ) ) ) ) ⊼ ( ( ( χ ⊼ χ ) ⊼ ψ ) ⊼ ( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ ⊼ ( χ ⊼ χ ) ) ) ) )",
        s4,
        ref="nic-idel",
        note="nic-idel",
    )

    # Step 6: nic-dfim — define φ → χ in terms of ⊼
    s6 = lb.ref(
        "s6",
        "( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ → χ ) ) ⊼ ( ( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ ⊼ ( χ ⊼ χ ) ) ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) )",
        ref="nic-dfim",
        note="nic-dfim",
    )
    ...
    s8 = lb.ref(
        "s8",
        "( ( φ → χ ) ⊼ ( φ → χ ) ) ⊼ ( ( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ ⊼ ( χ ⊼ χ ) ) ) ⊼ ( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ ⊼ ( χ ⊼ χ ) ) ) )",
        s7,
        ref="nic-idbl",
        note="nic-idbl",
    )
    ...
    s9 = lb.ref(
        "s9",
        "( ( ( χ ⊼ χ ) ⊼ ψ ) ⊼ ( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ ⊼ ( χ ⊼ χ ) ) ) ) ⊼ ( ( ( ( φ → χ ) ⊼ ( φ → χ ) ) ⊼ ( ( χ ⊼ χ ) ⊼ ψ ) ) ⊼ ( ( ( φ → χ ) ⊼ ( φ → χ ) ) ⊼ ( ( χ ⊼ χ ) ⊼ ψ ) ) )",
        s8,
        ref="nic-imp",
        note="nic-imp",
    )

    # Step 10: nic-dfim — define ψ → χ in terms of ⊼
    s10 = lb.ref(
        "s10",
        "( ( ψ ⊼ ( χ ⊼ χ ) ) ⊼ ( ψ → χ ) ) ⊼ ( ( ( ψ ⊼ ( χ ⊼ χ ) ) ⊼ ( ψ ⊼ ( χ ⊼ χ ) ) ) ⊼ ( ( ψ → χ ) ⊼ ( ψ → χ ) ) )",
        ref="nic-dfim",
        note="nic-dfim",
    )
    ...
    s14 = lb.ref(
        "s14",
        "( ( ( φ → χ ) ⊼ ( φ → χ ) ) ⊼ ( ( χ ⊼ χ ) ⊼ ψ ) ) ⊼ ( ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) ⊼ ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) )",
        s13,
        ref="nic-imp",
        note="nic-imp",
    )

    # Step 15: nic-ich(s9, s14)
    s15 = lb.ref(
        "s15",
        "( ( ( χ ⊼ χ ) ⊼ ψ ) ⊼ ( ( φ ⊼ ( χ ⊼ χ ) ) ⊼ ( φ ⊼ ( χ ⊼ χ ) ) ) ) ⊼ ( ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) ⊼ ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) )",
        s9,
        s14,
        ref="nic-ich",
        note="nic-ich",
    ...
    # Step 16: nic-ich(s5, s15)
    s16 = lb.ref(
        "s16",
        "( φ ⊼ ( ψ ⊼ ψ ) ) ⊼ ( ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) ⊼ ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) )",
        s5,
        s15,
        ref="nic-ich",
        note="nic-ich",
    ...
    # Step 17: nic-dfim — define (ψ → χ) → (φ → χ) in terms of ⊼
    s17 = lb.ref(
        "s17",
        "( ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) ⊼ ( ( ψ → χ ) → ( φ → χ ) ) ) ⊼ ( ( ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) ⊼ ( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) ) ⊼ ( ( ( ψ → χ ) → ( φ → χ ) ) ⊼ ( ( ψ → χ ) → ( φ → χ ) ) ) )",
        ref="nic-dfim",
        note="nic-dfim",
    )
    ...
    s18 = lb.ref(
        "s18",
        "( ( ψ → χ ) ⊼ ( ( φ → χ ) ⊼ ( φ → χ ) ) ) ⊼ ( ( ( ψ → χ ) → ( φ → χ ) ) ⊼ ( ( ψ → χ ) → ( φ → χ ) ) )",
        s17,
        ref="nic-bi1",
        note="nic-bi1",
    )

    # Step 19: nic-ich(s16, s18)
    s19 = lb.ref(
        "s19",
        "( φ ⊼ ( ψ ⊼ ψ ) ) ⊼ ( ( ( ψ → χ ) → ( φ → χ ) ) ⊼ ( ( ψ → χ ) → ( φ → χ ) ) )",
        s16,
        s18,
        ref="nic-ich",
        note="nic-ich",
    ...
    # Step 21: nic-dfim — define (φ → ψ) → ((ψ → χ) → (φ → χ)) in terms of ⊼
    s21 = lb.ref(
        "s21",
        "( ( ( φ → ψ ) ⊼ ( ( ( ψ → χ ) → ( φ → χ ) ) ⊼ ( ( ψ → χ ) → ( φ → χ ) ) ) ) ⊼ ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) ⊼ ( ( ( ( φ → ψ ) ⊼ ( ( ( ψ → χ ) → ( φ → χ ) ) ⊼ ( ( ψ → χ ) → ( φ → χ ) ) ) ) ⊼ ( ( φ → ψ ) ⊼ ( ( ( ψ → χ ) → ( φ → χ ) ) ⊼ ( ( ψ → χ ) → ( φ → χ ) ) ) ) ) ⊼ ( ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ⊼ ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ) )",
        ref="nic-dfim",
        note="nic-dfim",
    )
    ...
    s22 = lb.ref(
        "s22",
        "( ( φ → ψ ) ⊼ ( ( ( ψ → χ ) → ( φ → χ ) ) ⊼ ( ( ψ → χ ) → ( φ → χ ) ) ) ) ⊼ ( ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) ⊼ ( ( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) ) ) )",
        s21,
        ref="nic-bi1",
        note="nic-bi1",
    )

    # Step 23: nic-mp(s20, s22) — final modus ponens
    res = lb.ref(
        "res",
        "( φ → ψ ) → ( ( ψ → χ ) → ( φ → χ ) )",
        s20,
